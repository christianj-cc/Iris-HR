<div class="sidebar" style="display: flex;">
    ...
    <ul class="nav-links">
        ...
        <li><a href="employees.php" class="<?= $currentPage == 'employees-archived.php' ? 'active' : '' ?>"><svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" class="icon">

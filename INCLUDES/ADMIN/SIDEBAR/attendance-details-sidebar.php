<div class="sidebar" style="display: flex;">
    ...
    <ul class="nav-links">
        ...
        <li><a href="attendance.php" class="<?= $currentPage == 'attendance-details.php' ? 'active' : '' ?>"><svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 24 24" class="icon1">

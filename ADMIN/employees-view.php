<?php
include '../DATABASE/db_viewEmployee.php';
...
<body>
    <div class="container">
        ...
        <div class="main-content">
            <div id="title">
                <h2><i class="fa fa-bars sidebar-menu" id="menu-toggle">&nbsp&nbsp</i>Employee Details</h2>
            </div>
                    ...
                    <div class="profile-container">
                        ...
                        if (isset($employee)) {
                            ...
                            if (!file_exists($profilePic)) {
                                echo "File does NOT exist at: " . $profilePic;
                            }
                        } else {
